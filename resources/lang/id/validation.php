    ...
    */
    ...
    'custom' => [
        ...
        'jenis_kelamin' => [
            ...
            'in' => 'JENIS KELAMIN harus dipilih L atau P.',
        ],

        'tanggal_lahir' => [
            'required' => 'Kolom TANGGAL LAHIR harus diisi.',
            'date' => 'Kolom TANGGAL LAHIR harus diisi dengan format tanggal yang benar.',
        ],

        'nomor_telepon' => [
            'numeric' => 'NOMOR TELEPON harus berupa angka.',
            'digits_between' => 'NOMOR TELEPON harus terdiri dari 10 sampai 15 digit angka.',
        ...
        'foto' => [
            ...
            'max' => 'Ukuran Foto tidak boleh lebih dari 2048 KB',
            'mimes' => 'Foto hanya boleh diisi file dengan format *.jpg, *.jpeg, *.bmp, *.png',
        ],
    ],
